...
test.describe("New API Test", () => {
  test("useer should be able to create a new post @api", async ({
    apiUtils,
  }) => {
  ...
  test("user should be able to get the posts data @api", async ({
    apiUtils,
  }) => {
  ...
  test("user should be able to update the post data @api", async ({
    apiUtils,
  }) => {
    const updatedData = {
      title: "Updated Title",
  ...
  test("user should be able to delete the post data @api", async ({
    apiUtils,
  }) => {
